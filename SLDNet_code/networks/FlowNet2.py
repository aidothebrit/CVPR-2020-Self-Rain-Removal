...
import networks.FlowNetC
import networks.FlowNetS
import networks.FlowNetSD
import networks.FlowNetFusion
...
class FlowNet2C(networks.FlowNetC.FlowNetC):
...
class FlowNet2S(networks.FlowNetS.FlowNetS):
    def __init__(self, args, batchNorm=False, div_flow=20):
...
class FlowNet2SD(networks.FlowNetSD.FlowNetSD):
    def __init__(self, args, batchNorm=False, div_flow=20):
